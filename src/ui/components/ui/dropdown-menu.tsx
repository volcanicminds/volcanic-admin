...
// Same look as DropdownMenuContent but written out rather than reused: that one
// wraps its own Portal, while a submenu panel is positioned by its parent menu and
// must NOT be portalled away from it.
